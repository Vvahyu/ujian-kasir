        ...
        <?php 
			...
			if($r > 0){
				...
				<div class='alert alert-warning'>
					<span class='glyphicon glyphicon-info-sign'></span> Ada <span style='color:red'>$r</span> barang yang Stoknya meinipis. silahkan pesan lagi !!
                    ...
                    <form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
                        <div class="modal-body">
                            <table class="table table-striped bordered">
                                ...
                                <tr>
                                    <td>Modal</td>
                                    <td><input type="number" placeholder="Modal" required class="form-control"
                                            name="beli"></td>
                                </tr>
                                <tr>
                                    <td>Harga Jual</td>
