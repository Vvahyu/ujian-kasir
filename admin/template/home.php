...
<?php
		...
		<div class='alert alert-warning'>
			<span class='glyphicon glyphicon-info-sign'></span> Ada <span style='color:red'>$r</span> barang yang Stok tersisa sudah  4 items. silahkan pesan lagi !!
...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fa fa-upload"></i>Transaksi</h6>
            </div>

            <div class="card-footer" style=text-align:center;>
                <a href='index.php?page=jual'>Jual<i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
    </div>
</div>